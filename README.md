...
- **TTS引擎**：支持浏览器本机语音、OpenAI/OpenAI兼容 TTS、Azure Speech 和自定义兼容接口
- **主持人播报**：主持人公开公告与AI玩家发言进入统一播放队列，私密消息不会播报
- **独立音色**：玩家和主持人可分别选择音色、语速、音量及音频格式
- **可靠播放**：支持暂停、继续、停止、请求超时和云端失败自动回退本机语音
- **配置文档**：参见 [云端语音配置](docs/云端语音配置.md)
